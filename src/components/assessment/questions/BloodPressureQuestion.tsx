...
export function BloodPressureQuestion({ onValueChange, onAdvance, value }: BloodPressureQuestionProps) {
  const handleAnswer = (hasBloodPressure: boolean) => {
    onValueChange(hasBloodPressure);
    ...
    <div className="h-screen flex items-center justify-center py-24 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl text-center space-y-8 relative z-10">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl mx-auto shadow-glow"
        >
        ...
        <div className="space-y-4">
          ...
          >
            Understanding your cardiovascular health is important
          </motion.p>
        </div>
